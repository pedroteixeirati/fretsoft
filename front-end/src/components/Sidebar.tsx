  ...
  const allSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'serviceOrders', label: 'Ordens de servico', icon: Wrench, allowed: canAccess(userProfile, 'serviceOrders', 'read') },
        { id: 'maintenanceInspections', label: 'Manutencao preventiva', icon: ClipboardCheck, allowed: canAccess(userProfile, 'maintenanceInspections', 'read') },
        { id: 'inventory', label: 'Almoxarifado', icon: Boxes, allowed: canAccess(userProfile, 'inventory', 'read') },
      ],
    },
    {
      id: 'management',
