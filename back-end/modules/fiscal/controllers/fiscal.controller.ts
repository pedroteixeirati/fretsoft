...
import { createFiscalDocument, getFiscalDocument, listTenantFiscalDocuments, removeFiscalDocument, updateFiscalDocument } from '../services/fiscal-documents.service';
